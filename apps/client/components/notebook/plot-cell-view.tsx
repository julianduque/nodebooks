...
} from "@/components/notebook/plot-layout-committers";
import {
  Plus,
  Trash2,
  ScatterChart,
...
type BlurDisposable = ReturnType<
  MonacoEditorApi.IStandaloneCodeEditor["onDidBlurEditorText"]
>;
...
type GlobalDataSource = Extract<PlotDataSource, { type: "global" }>;
...
const PlotCellView = ({
  ...
  return (
    <div
      className="space-y-4 rounded-xl border border-border/60 bg-card/60 p-4 text-sm"
            ...
            <div className="grid w-full gap-3 md:grid-cols-3 md:items-end">
              <label className="flex flex-col gap-1 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
                ...
                <div className="relative">
                  ...
                  />
                  <select
                    className="h-9 w-full appearance-none rounded-md border border-border bg-background pl-8 pr-10 text-sm"
                                  ...
                                  <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <label className="flex flex-col gap-1">
                                      ...
                                      <select
                                        ...
                                        onChange={(event) =>
                                          handleTraceChange(index, {
                                            z: event.target.value || undefined,
                                          })
                                        }
                                      >
                                        <option value="">
                                    ...
                                    <label className="flex flex-col gap-1">
                                      ...
                                      <span className="text-[11px] text-muted-foreground/80">
                                        Control filled areas and stacked groups.
                                      </span>
                                    </label>
                                  </div>
                                </td>
