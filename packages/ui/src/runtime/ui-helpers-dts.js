...
export declare function UiImage(
  src: string,
  opts?: UiImageOptions
): UiDisplayHandle<{ ui: "image" } & UiImageOptions & { src: string }>;
export declare function UiImage(
...
export declare function UiJSON(
  json: unknown,
  opts?: UiJsonOptions
): UiDisplayHandle<{ ui: "json"; json: unknown } & UiJsonOptions>;
export type UiCodeOptions = { language?: string };
export declare function UiCode(
  code: string,
  opts?: UiCodeOptions
): UiDisplayHandle<{ ui: "code"; code: string } & UiCodeOptions>;
...
export declare function UiTable(
  ...
  { ui: "table"; rows: Array<Record<string, unknown>> } & UiTableOptions
>;
export declare function UiTable(
...
): UiDisplayHandle<{ ui: "dataSummary" } & UiDataSummaryOptions>;
export type UiVegaLiteOptions = {
  height?: number;
  width?: number;
  renderer?: "canvas" | "svg";
  actions?: boolean;
...
export declare function UiVegaLite(
  ...
  { ui: "vegaLite"; spec: Record<string, unknown> } & UiVegaLiteOptions
>;
export declare function UiVegaLite(
...
export declare function UiPlotly(
  ...
  { ui: "plotly"; data: unknown[] } & UiPlotlyOptions
>;
export declare function UiPlotly(
...
): UiDisplayHandle<{ ui: "heatmap"; values: number[][] } & UiHeatmapOptions>;
export declare function UiHeatmap(
...
export type UiNetworkGraphOptions = {
  physics?: {
    linkDistance?: number;
...
): UiDisplayHandle<{ ui: "plot3d" } & UiPlot3dOptions>;
...
export declare function UiMap(
  opts?: UiMapOptions
): UiDisplayHandle<{ ui: "map" } & UiMapOptions>;
...
export declare function UiAlert(
  opts: UiAlertOptions
): UiDisplayHandle<{ ui: "alert" } & UiAlertOptions>;
export type UiBadgeOptions = {
  color?: "neutral" | "info" | "success" | "warn" | "error";
};
export declare function UiBadge(
  text: string,
  opts?: UiBadgeOptions
): UiDisplayHandle<{ ui: "badge"; text: string } & UiBadgeOptions>;
export declare function UiBadge(
  opts: { ui?: "badge"; text: string } & UiBadgeOptions
): UiDisplayHandle<{ ui: "badge"; text: string } & UiBadgeOptions>;
export type UiMetricOptions = {
  label?: string;
  unit?: string;
  delta?: number;
  helpText?: string;
...
): UiDisplayHandle<{ ui: "metric"; value: string | number } & UiMetricOptions>;
export declare function UiMetric(
  opts: { ui?: "metric"; value: string | number } & UiMetricOptions
): UiDisplayHandle<{ ui: "metric"; value: string | number } & UiMetricOptions>;
export type UiProgressOptions = {
  label?: string;
  max?: number;
...
export declare function UiProgress(
  ...
  { ui: "progress"; value: number } & UiProgressOptions
>;
export declare function UiProgress(
  opts: { ui?: "progress"; value?: number; max?: number; indeterminate?: boolean }
): UiDisplayHandle<
  { ui: "progress" } & UiProgressOptions & { value?: number }
>;
export type UiSpinnerOptions = {
  label?: string;
  size?: number | "sm" | "md" | "lg";
};
export declare function UiSpinner(
  opts?: UiSpinnerOptions
): UiDisplayHandle<{ ui: "spinner" } & UiSpinnerOptions>;
`;
