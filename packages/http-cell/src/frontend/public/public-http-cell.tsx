    ...
    <section id={`cell-${cell.id}`} className="space-y-4 text-sm">
      <div className="space-y-3 rounded-lg border border-border bg-muted/40 p-4">
        <div className="flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground">
          <span className="rounded border border-primary/30 bg-primary/10 px-2 py-1 font-mono text-[11px] font-semibold uppercase tracking-wide text-primary shadow-sm">
            {request.method ?? "GET"}
          </span>
      ...
      {response ? (
        <div className="space-y-3 rounded-lg border border-border bg-card/80 p-4">
          <div className="flex flex-wrap items-center gap-2">
            <span className="rounded border border-primary/30 bg-primary/10 px-2 py-1 text-xs font-semibold uppercase tracking-wide text-primary shadow-sm">
              Response
            </span>
            {timestampLabel ? (
